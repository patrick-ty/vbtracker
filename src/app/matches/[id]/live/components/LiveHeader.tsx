  ...
  return (
    <div className="bg-blue-700 text-white shrink-0 py-3">
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'stretch' }}>
        ...
        <div style={{ width: '40%', flexShrink: 0, padding: '0 24px' }}>
          {/* Exit */}
          <Link href={`/matches/${match.id}`} className="text-blue-200 hover:text-white text-sm font-medium transition-colors">
            &larr; Exit
          </Link>

          {/* Event name */}
          {eventName && (
            <p className="text-xl font-bold text-white leading-tight mt-2">{eventName}</p>
          )}
